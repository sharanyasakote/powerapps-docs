...
(Check this for Camera Related App Restart Issues - https://learn.microsoft.com/en-us/power-apps/maker/canvas-apps/controls/control-camera) -- Solved
For Resolution Issue follow this thread - https://ideas.powerapps.com/d365community/idea/0a03691a-c964-4dda-8a2e-594245e45ac3 -- Solved
Check the Image resolution generated by the camera control in iPhone and Android (Specifically above 400 PPI) -- Solved -- Microsoft PG Team fixed it for particular Tenant ID and Organisation ID - However previously low quality pictures were captured, settings changed pertaining to Android mobile devices which has more than 400 PPI. 
